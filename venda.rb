...
while ale == teste		
	...
	fim -= 1
	puts "Aguarde..."
	arquivo = File.new("VENDA_#{arquivo_nome}.txt", "w")
								...
								begin
									...
									if mensagens > 90
										...
										begin
											...
											p h =  "http://www.olx.com.br/veiculos/pecas-e-acessorios?o=#{inicio}&ot=1&q=#{palavra}"
											page = agent.get("http://www.olx.com.br/veiculos/pecas-e-acessorios?o=#{inicio}&ot=1&q=#{palavra}")
													...
													if b.url == link.href
														...
														if s == true 
															...
															b.button(text: "Iniciar chat").click
												  			sleep 1
												  			b.textarea(name: 'message').when_present.set "Olá Amigo! Tenho um comprador certo para este #{palavra} e ele está cadastrado no PAGO ATÉ. Acesse agora e entre em contato com ele. http://pagoate.com.br/anuncios/compro-multimidia-corolla-2011" #preencher
